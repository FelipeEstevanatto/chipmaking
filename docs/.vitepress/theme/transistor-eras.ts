...
/**
 * One-line payoff of each generation, keyed by `year` — the "ganho" column the chapter's table
 * carried and the timeline did not. Kept out of `ERAS` because the timeline never renders it.
 */
export const ERA_GAINS: Record<string, { pt: string; en: string }> = {
  '1960': { pt: 'Base da Lei de Moore por décadas', en: "Basis of Moore's Law for decades" },
  '1963': {
    pt: 'Consumo quase nulo em repouso — base de toda a lógica digital',
    en: 'Near-zero standby power — the basis of all digital logic',
  },
  '1968': {
    pt: 'Menos capacitância de sobreposição; dispositivos menores e mais rápidos',
    en: 'Less overlap capacitance; smaller, faster devices',
  },
  '1985': {
    pt: 'Suaviza o campo no dreno e contém portadores quentes',
    en: 'Smooths the drain field and contains hot carriers',
  },
  '1995': {
    pt: 'Paredes verticais, sem “bico de pássaro”; mais densidade',
    en: 'Vertical walls, no “bird\u2019s beak”; more density',
  },
  '1998': {
    pt: 'Menos capacitância de junção e imunidade ao latch-up',
    en: 'Less junction capacitance and latch-up immunity',
  },
  '2003': {
    pt: '+10–20% de mobilidade com custo marginal',
  ...
  '2011': {
    ...
    en: 'Electrostatic control; current scalable by fins',
  },
  '2012': {
    pt: 'Back bias ajusta a tensão de limiar; baixo consumo e menos variabilidade',
    en: 'Back bias tunes threshold voltage; low power and less variability',
  },
  '2022': {
    pt: 'Até ~40% menos vazamento',
    en: 'Up to ~40% less leakage',
  },
  '2025/2026': {
    pt: '~11% mais densidade; IR drop até 10× menor',
    en: '~11% more density; IR drop up to 10× lower',
  },
  '~2029': {
    pt: 'Aproxima n e p sem empilhar; células padrão menores',
    en: 'Brings n and p closer without stacking; smaller standard cells',
  },
  'Futuro': {
    pt: 'Até ~50% menos área por porta lógica',
    en: 'Up to ~50% less area per logic gate',
  },
}
