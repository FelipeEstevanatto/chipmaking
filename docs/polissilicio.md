...
O MG-Si triturado é injetado em um reator de leito fluidizado onde reage com gás clorídrico anidro (HCl) sob alta pressão, produzindo o gás **triclorossilano** (TCS, SiHCl₃) e hidrogênio (H₂) <Cite id="pv-education" />:

```text
Si + 3HCl → SiHCl₃ + H₂
```

Com ponto de ebulição baixo de apenas **31,8 °C**, o TCS gasoso é purificado por sucessivos processos de destilação fracionada <Cite id="ratedpower" />, removendo com alta precisão cloretos de metais, boro e fósforo.
...
Criado na década de 1950 pelas empresas Siemens e Wacker, é o método dominante no mercado mundial <Cite id="bernreuter" />. O gás TCS é injetado com hidrogênio (H₂) em um reator de redoma de aço onde filamentos de silício em forma de “U” são aquecidos eletricamente a cerca de **1100–1150 °C** <Cite id="bernreuter" />. O silício se deposita termicamente nos filamentos até formar bastões sólidos de 15 a 20 cm de diâmetro <Cite id="ratedpower" />. É um processo de altíssimo consumo de energia. Os bastões são colhidos e fraturados em pedaços para uso.
